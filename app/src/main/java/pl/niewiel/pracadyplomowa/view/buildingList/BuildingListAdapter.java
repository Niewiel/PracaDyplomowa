...
import pl.niewiel.pracadyplomowa.view.building.BuildingView;

public class BuildingListAdapter extends ArrayAdapter<Building> {
    BuildingListAdapter(@NonNull Context context, int resource, @NonNull List<Building> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.building_list_row, parent, false);
