...
import pl.niewiel.pracadyplomowa.placeholders.ComponentTypeViewHolder;

public class ComponentTypeAdapter extends ArrayAdapter<ComponentType> {
    public ComponentTypeAdapter(@NonNull Context context, int resource, @NonNull List<ComponentType> objects) {
